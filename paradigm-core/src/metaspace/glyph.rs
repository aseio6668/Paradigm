...
impl Glyph {
    ...
    pub fn is_ml_related(&self) -> bool {
        matches!(self.category, DataCategory::Model | DataCategory::Dataset | DataCategory::Result)
    }
