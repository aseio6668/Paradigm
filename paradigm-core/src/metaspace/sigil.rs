...
impl Sigil {
    ...
    pub fn new(data: Vec<u8>, glyph: Glyph, originator: String, shard_index: usize) -> Result<Self> {
    ...
    pub fn record_retrieval(&mut self, requester: Option<String>, keeper_id: String, success: bool) {
    ...
    pub fn calculate_keeper_rewards(&self, total_reward_pool: u64) -> HashMap<String, u64> {
        ...
        let successful_retrievals: HashMap<String, u64> = self.retrievals
            .iter()
            .filter(|r| r.success)
